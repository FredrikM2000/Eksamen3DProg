...
//!
void OctahedronBall::subDivide(const QVector3D &a, const QVector3D &b, QVector3D &c, int n)
{
    if(n>0){
        QVector3D v1 = a+b; v1.normalize();
        QVector3D v2 = a+b; v2.normalize();
        QVector3D v3 = a+b; v3.normalize();
...
//Rettelse 18/2: Parameter 3 i glUniformMatrix4fv skal være GL_FALSE når vi bruker QMatrix4x4.
