...
void Matrix4x4::setPositionX(GLfloat x)
{
    matrix[3] = x;

}

void Matrix4x4::setPositionY(GLfloat y)
{
    matrix[7] = y;

}

void Matrix4x4::setPositionZ(GLfloat z)
{
    matrix[11] = z;
...
{
    return Vector3D(matrix[3], matrix[7], matrix[11]);
}

Vector2D Matrix4x4::getPosition2D()
{
    return Vector2D(matrix[3], matrix[11]);
}

void Matrix4x4::rotateX(GLfloat degrees)
{
    GLfloat rad = gsl::deg2radf(degrees);
