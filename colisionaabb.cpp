...
CollisionBox::CollisionBox(std::vector<Vertex> object)
{
...
CollisionBox::CollisionBox(VisualObject *obj)
{
...
void CollisionBox::init(GLint matrixUniform)
{
...
std::vector<float> CollisionBox::findValues(std::vector<Vertex> vertices)
{
...
bool CollisionBox::isColliding(VisualObject *other, gsl::Vector2D playerPos)
{
